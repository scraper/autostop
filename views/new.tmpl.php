    				...
    				<div id="controls">
						<form class="well" action="new.php" method="post" onsubmit="return validation();">
							<div class="directions">
								...
								<input class="span12" type="text" id="start" name="origin" onkeypress="calcRoute();" onchange="calcRoute();" onblur="calcRoute();" onfocus="calcRoute();"/>
								<label id="b" for="end">Їду в місто:</label>
								<input class="span12" type="text" id="end" name="destination" onkeypress="calcRoute();" onchange="calcRoute();" onblur="calcRoute();" onfocus="calcRoute();"/>
